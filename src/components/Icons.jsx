/** Reusable SVG icons for portfolio sections */
...
export function BriefcaseIcon({ className = 'w-6 h-6' }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6v.01M12 12v.01M20 12v.01M12 16v.01M12 8v.01M16 16v.01M8 16v.01M8 8v.01" />
    </svg>
  )
}
